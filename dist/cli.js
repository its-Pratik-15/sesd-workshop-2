...
github
  ...
  URL:        ${u.html_url}
      `);
        ...
        console.error('Error:', ((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) === 404 ? 'User not found' : err.message);
    }
});
github
...
github
  ...
  URL:         ${r.html_url}
      `);
        ...
        console.error('Error:', ((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) === 404 ? 'Repo not found' : err.message);
    }
});
github
    .command('trending')
